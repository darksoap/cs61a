...
class ThrowerAnt(Ant):
    ...
    def nearest_bee(self, hive):
        ...
        while current_place != hive:
            if current_place.bees and distance in range(self.min_range, self.max_range):
...
# The WallAnt class
class WallAnt(Ant):
    """A WallAnt that does nothing each turn. """
    name = 'Wall'
    implemented = True
    food_cost = 4
        ...
        if self.is_true:
            ...
            while current_place.exit:
                if current_place.ant:
                    if isinstance(current_place.ant, BodyguardAnt) and current_place.ant.ant and current_place.ant.ant not in self.have_double:
                        current_place.ant.ant.damage *= 2
                        self.have_double.append(current_place.ant.ant)
                    if current_place.ant not in self.have_double:
                        current_place.ant.damage *= 2
                        self.have_double.append(current_place.ant)
